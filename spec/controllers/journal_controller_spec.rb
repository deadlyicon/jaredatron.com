...
describe JournalController do
  ...
  # JournalController. Be sure to keep this updated too.
  let(:valid_session) { {} }

  describe "GET index" do
    it "assigns all journal as @journal" do
      journal_entry = JournalEntry.create! valid_attributes
      get :index, {}, valid_session
      assigns(:journal).should eq([journal_entry])
    end
  end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested journal_entry" do
        journal_entry = JournalEntry.create! valid_attributes
        # Assuming there are no other journal in the database, this
        # specifies that the JournalEntry created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        JournalEntry.any_instance.should_receive(:update).with({ "body" => "MyText" })
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the journal list" do
      journal_entry = JournalEntry.create! valid_attributes
      delete :destroy, {:id => journal_entry.to_param}, valid_session
